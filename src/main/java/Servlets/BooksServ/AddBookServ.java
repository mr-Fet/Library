...
@WebServlet(urlPatterns = "/AddBookServ")
public class AddBookServ extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            if(book!=null){
                writer.println("Книга с таким ID уже существует");
            }
            else {
                booksService.createBook(bookId,bookName,authorId,category);

                writer.println("Книга успешно создана " + "<br/>");
